...
export default function TcuComunicacoes({ 
 ...
 const [comSearchTerm, setComSearchTerm] = useState("");
  const [comAnoFilter, setComAnoFilter] = useState("TODOS"); // Default: all years
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <>
  ...
  <div className="flex flex-col gap-4">
  {/* Top Row: Action Buttons + unique Lote counter on left, Search on right */}
  <div className="flex flex-col xl:flex-row gap-4 justify-between items-start xl:items-center w-full">
  <div className="flex flex-wrap gap-2 items-center">
  <div className="flex items-center gap-2">
  {/* Unique to Comunicações: Lote de Ofícios counter */}
  <span className="px-3.5 py-2 bg-slate-100 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 inline-flex items-center gap-1.5">
  ...
  className={`px-4 py-2.5 rounded-xl font-bold text-xs inline-flex items-center gap-1.5 transition duration-200 ${isSyncingLocalCom ? "bg-slate-800 text-white shadow-xs opacity-50" : "bg-[#003366] text-white hover:bg-[#0f4396] shadow-sm"}`}
  ...
  <span className="font-semibold text-slate-500 shrink-0">Unidade:</span>
  <select
 ...
 {/* Row Item */}
 <tr className={`hover:bg-[#1351b4]/5 transition-colors group border-b border-slate-100 ${isExpanded ? "bg-blue-50/50" : ""}`}>
 ...
 {/* Destinatário */}
 <td className="p-4 align-middle font-semibold text-slate-800 truncate max-w-[280px]" title={item.DESTINATARIO}>
 {item.DESTINATARIO}
 </td>

 {/* Processo */}
 <td className="p-4 align-middle text-xs text-slate-600 text-center whitespace-nowrap">
 {item.PROCESSO || <span className="text-slate-350 italic">Não associado</span>}
 </td>

 {/* Expedição */}
 <td className="p-4 align-middle text-slate-500 text-center whitespace-nowrap font-medium">
 {item.DATA_EXPEDICAO}
 </td>
 ...
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider leading-none mb-1">Emitente TCU</span>
 ...
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider leading-none mb-1">Contato Vinculado</span>
 ...
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider leading-none mb-1">Data da Resposta</span>
 ...
 className="px-3.5 py-1.5 rounded-lg text-xs font-black uppercase tracking-wider bg-[#003366] hover:bg-slate-900 text-white cursor-pointer transition shadow-2xs shrink-0"
 ...
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider leading-none mb-1">Unidade Executora</span>
 ...
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider leading-none mb-1">Processo SEI</span>
 ...
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider leading-none mb-1">Destinação</span>
 <span className="text-xs text-slate-700 font-bold block">
 {item.DESTINACAO === "ARQUIVAMENTO" ? (
 <span className="bg-slate-100 text-slate-700 border border-slate-200/60 px-2 py-0.5 rounded-full text-xs font-black uppercase">
 Arquivamento
 </span>
 ) : item.DESTINACAO === "RESPOSTA" ? (
 <span className="bg-blue-50 text-blue-800 border border-blue-200/60 px-2 py-0.5 rounded-full text-xs font-black uppercase">
 Resposta
 </span>
 ) : (
 ...
 {/* Sub Tab View 2 removed — statistics moved to Painel Gerencial */}
 {false && (
 ...
 <table className="w-full text-left border-collapse text-sm text-slate-800">
 <thead>
 <tr className="sticky top-0 z-10 backdrop-blur-sm border-b border-[#002244]">
 <th className="p-4 font-semibold hover:bg-[#002244] transition-colors cursor-pointer hover: transition-colors">Unidade do Ministério do Trabalho (Destinatário)</th>
 <th className="p-4 font-semibold hover:bg-[#002244] transition-colors w-[130px] cursor-pointer hover: transition-colors">Ofícios Recebidos</th>
 <th className="p-4 font-semibold hover:bg-[#002244] transition-colors w-[130px] cursor-pointer hover: transition-colors">Demandam Resposta</th>
 <th className="p-4 font-semibold hover:bg-[#002244] transition-colors w-[130px] cursor-pointer hover: transition-colors">Respondidos</th>
 <th className="p-4 font-semibold hover:bg-[#002244] transition-colors w-[130px] cursor-pointer hover: transition-colors">Pendentes (Em Aberto)</th>
 <th className="p-4 font-semibold hover:bg-[#002244] transition-colors w-[200px] cursor-pointer hover: transition-colors">% de Representação no Órgão</th>
 <th className="p-4 font-semibold hover:bg-[#002244] transition-colors w-[130px] cursor-pointer hover: transition-colors">Índice de Conclusão</th>
 </tr>
 </thead>
 ...
 <td className="p-4 align-middle text-slate-800 font-black flex items-center ga text-sm">
 ...
 <td className="p-4 align-middle text-center text-slate-900 font-bold text-sm">
 {stat.total}
 </td>
 <td className="p-4 align-middle text-center font-bold text-slate-600">
 {stat.requireResponseTotal}
 </td>
 <td className="p-4 align-middle text-center font-bold text-emerald-700">
 {stat.responded}
 </td>
 <td className="p-4 align-middle text-center font-bold text-amber-700">
 {stat.pending}
 </td>
 ...
 <div className="space-y-1">
 <label className="text-xs font-semibold text-slate-700 uppercase tracking-wider block">Unidade Emitente</label>
 <input
 type="text"
 ...
 <div className="space-y-1">
 <label className="text-xs font-semibold text-slate-700 uppercase tracking-wider block">Processo Associado</label>
 <input
 type="text"
 className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl"
 ...
 <div className="space-y-1">
 <label className="text-xs font-semibold text-slate-700 uppercase tracking-wider block">Contato de Referência</label>
 <input
 type="text"
 className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl"
 ...
 <div className="space-y-1">
 <label className="text-xs font-semibold text-slate-700 uppercase tracking-wider block">Unidade Executora</label>
 <input
 type="text"
 placeholder="Ex: SECI"
 ...
 <div className="space-y-1">
 <label className="text-xs font-semibold text-slate-700 uppercase tracking-wider block">Nº Processo SEI</label>
 <input
 type="text"
 ...
 <div className="space-y-1">
 <label className="text-xs font-semibold text-slate-700 uppercase tracking-wider block">Destinação da Comunicação</label>
 ...
 <div className="grid grid-cols-2 gap-3">
 <div className="space-y-1">
 <label className="text-xs font-semibold text-slate-700 uppercase tracking-wider block">Data de Expedição</label>
 <input
 type="text"
 ...
 <div className="space-y-1">
 <label className="text-xs font-semibold text-slate-700 uppercase tracking-wider block">Data da Resposta</label>
 <input
 type="text"
 ...
 />
 <label htmlFor="edit-com-carece" className="text-sm font-bold text-slate-700 cursor-pointer select-none">
 ...
 <span className={`text-sm font-black uppercase ${resolved ? 'text-emerald-700' : 'text-amber-700'}`}>
 {resolved ? "Comunicação Respondida" : "Contagem de Prazo / Tempo Decorrido"}
 </span>
 </div>
 <span className={`text-xs font-bold ${resolved ? 'text-emerald-800' : 'text-amber-800'}`}>
 ...
 className="flex-1 min-w-[145px] py-2 px-3 border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-[#003366] rounded-xl text-xs font-black uppercase tracking-wider flex items-center justify-center gap-1.5 transition duration-155 cursor-pointer"
 >
 ...
 className={`px-3 py-1.5 rounded-lg text-sm font-bold border transition flex items-center gap-1.5 cursor-pointer ${
 copySuccessFullText
