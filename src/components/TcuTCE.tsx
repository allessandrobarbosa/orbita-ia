...
export default function TcuTCE({
 ...
 <span className="mt-2 text-xs bg-[#003366] hover:bg-slate-900 text-white font-bold px-3 py-1 rounded-lg shadow-2xs">
 ...
 className="w-full flex-1 p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:ring-1 focus:ring-[#003366] focus:bg-white focus:outline-hidden transition"
 ...
 <h4 className="text-sm font-black uppercase text-slate-400 tracking-wider">Metadados Principais</h4>
 ...
 />
 <p className="text-xs text-slate-500">Este texto será exibido como a última manifestação técnica nos cards de detalhes.</p>
 </div>
 </div>
 ...
 <div className="bg-slate-50 px-3 py-2 text-xs font-bold text-slate-500 uppercase border-b border-slate-200">
 Vínculos Atuais
 </div>
 ...
 <span className=" text-[#003366] font-semibold">{m.ACORDAO_KEY}</span>
 <button
 onClick={async () => {
 ...
 <th className="p-4 cursor-pointer hover:bg-slate-100 transition-colors">Nº / Ano (TCE)</th>
 <th className="p-4 cursor-pointer hover:bg-slate-100 transition-colors">Processo TCU</th>
 <th className="p-4 cursor-pointer hover:bg-slate-100 transition-colors">Assunto / Motivo da Instauração</th>
 <th className="p-4 text-right cursor-pointer hover:bg-slate-100 transition-colors">Débito Atualizado</th>
 </tr>
 </thead>
 ...
 <td className="p-4 w-8 no-print text-slate-500">
 <button
 ...
 <td className="px-5 py-3.5 font-bold text-slate-900 group-hover:text-blue-900 transition-colors">{tce.NUMERO_ANO_TCE}</td>
 <td className="px-4 py-3.5 text-sm text-[#003366]">{tce.TC || "-"}</td>
 ...
 <td className="px-4 py-3.5 text-right font-bold text-slate-900">{tce.DEBITO_ATUALIZADO || "-"}</td>
 </tr>
 ...
 <span className="text-xs text-[#003366] font-black uppercase tracking-wider block pr-6">ID Registro / Chave</span>
 ...
 <span className="text-xs text-slate-400 font-bold uppercase tracking-wider block">Fase Processual</span>
 <span className="text-xs font-bold text-slate-700">{tce.ESTADO_PROCESSO || "Não Declarado"}</span>
 </div>
 <div className="bg-white border border-slate-200 p-4 rounded-2xl shadow-3xs space-y-1">
 <span className="text-xs text-slate-400 font-bold uppercase tracking-wider block">Situação Atual</span>
 <span className="text-xs font-bold text-slate-700">{tce.SITUACAO_PROCESSO || "Não Declarada"}</span>
 </div>
 <div className="bg-white border border-slate-200 p-4 rounded-2xl shadow-3xs space-y-1">
 <span className="text-xs text-[#1351b4] font-black uppercase tracking-wider block">Processo TCU</span>
 <span className="text-xs font-bold text-blue-900">{tce.TC || "Não Localizado"}</span>
 </div>
 </div>
 ...
 <h5 className="text-xs font-black uppercase text-[#003366] border-b border-slate-100 pb-1.5">Identificadores e Prazos</h5>
 <div className="space-y-1.5 text-sm text-slate-600">
 <p><span className="font-bold text-slate-400">Processo MTE (PA):</span> <span className=" text-slate-800">{tce.PROCESSO_ADMINISTRATIVO || "-"}</span></p>
 ...
 {/* Financial details */}
 <div className="bg-white p-4.5 rounded-2xl border border-slate-200/60 shadow-3xs space-y-3">
 <h5 className="text-xs font-black uppercase text-[#003366] border-b border-slate-100 pb-1.5">Mapeamento de Valores</h5>
 <div className="space-y-1.5 text-sm text-slate-600 ">
 ...
 <div className="space-y-1.5">
 <h5 className="text-xs font-black uppercase text-amber-800">Último Posicionamento Técnico AECI</h5>
 <p className="text-sm text-slate-700 italic leading-relaxed bg-white p-3 rounded-xl border border-slate-200/60 min-h-[70px]">
 “{tce.ULTIMO_POSICIONAMENTO || "Nenhum parecer técnico ou manifestação cadastrada de forma recente."}”
 </p>
 </div>
 <div className="text-xs text-slate-400 mt-2 flex items-center justify-between border-t border-amber-100/40 pt-2">
 ...
 <tr className="bg-slate-50/80 border-b border-slate-200 text-xs uppercase tracking-wider text-slate-500 font-semibold sticky top-0 z-10 backdrop-blur-sm">
 <th className="p-4 w-8 no-print cursor-pointer hover:bg-slate-100 transition-colors"></th>
 <th className="p-4 cursor-pointer hover:bg-slate-100 transition-colors">Nº TCE</th>
 <th className="p-4 font-sans cursor-pointer hover:bg-slate-100 transition-colors">Processo TCU / Motivo</th>
 <th className="p-4 cursor-pointer hover:bg-slate-100 transition-colors">Acórdão Mapeado (Referência)</th>
 <th className="p-4 cursor-pointer hover:bg-slate-100 transition-colors">Chave Base Recente</th>
 <th className="p-4 text-center cursor-pointer hover:bg-slate-100 transition-colors">Status Cruzamento</th>
 <th className="p-4 pr-6 cursor-pointer hover:bg-slate-100 transition-colors">Colegiado / Data Sessão</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-slate-100 text-xs">
 ...
 <td className="px-4 py-3.5 text-sm text-slate-500">{item.acordao?.KEY || "Indefinida / Não Ingerido"}</td>
 ...
 <td className="px-4 py-3.5 text-sm pr-6">
 ...
 <span className="bg-[#003366]/10 text-[#003366] text-xs font-black uppercase px-2.5 py-1 rounded-md">
 ...
 <p><span className="font-bold text-slate-400">Processo MTE/PA:</span> <span className=" text-slate-800">{item.tce.PROCESSO_ADMINISTRATIVO || "-"}</span></p>
 <p><span className="font-bold text-slate-400">Processo TCU:</span> <span className=" text-slate-800">{item.tce.TC || "-"}</span></p>
 ...
 <div className="space-y-2">
 <p><span className="font-bold text-slate-400">Débito Original:</span> <span className=" text-slate-800 font-semibold">{item.tce.DEBITO_ORIGINAL || "R$ 0,00"}</span></p>
 <p><span className="font-bold text-slate-400">Débito Atualizado:</span> <span className=" text-slate-850 font-bold text-emerald-700">{item.tce.DEBITO_ATUALIZADO || "-"}</span></p>
 <p><span className="font-bold text-slate-400">Data Atualização:</span> <span className="text-slate-700 ">{item.tce.DATA_ATUALIZACAO_DEBITO || "-"}</span></p>
 ...
 <span className="text-xs font-bold text-amber-800 block uppercase">Último Posicionamento Técnico</span>
 <p className="italic text-slate-750 bg-white p-2.5 rounded-lg border border-slate-200/60 leading-relaxed text-sm min-h-[50px]">
 {item.tce.ULTIMO_POSICIONAMENTO || "Nenhum parecer técnico recente cadastrado pelo supervisor."}
 </p>
 </div>
 </div>
 ) : (
 <div className="p-5 bg-slate-100/65 rounded-xl text-center text-slate-500 text-sm border border-dashed border-slate-200">
 ...
 <div className="bg-white p-5 rounded-3xl border border-slate-200/60 shadow-3xs space-y-4">
 <div className="flex items-center justify-between border-b border-slate-100 pb-2">
 <span className="bg-[#1351b4]/10 text-[#1351b4] text-xs font-black uppercase px-2.5 py-1 rounded-md">
 ...
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold">Identificador Único</span>
 <span className=" text-slate-800 font-bold">{item.acordao.KEY}</span>
 </div>
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold">Número / Colegiado</span>
 ...
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold">Ata & Sessão</span>
 <span className="text-slate-800 font-medium">Ata {item.acordao.NUMATA || "S/N"} • {item.acordao.DATASESSAO || "S/D"}</span>
 </div>
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold">Autoridade Relatora</span>
 ...
 <span className="text-xs text-slate-400 block uppercase font-bold">Assunto do Acórdão</span>
 <p className="text-slate-800 font-semibold">{item.acordao.ASSUNTO}</p>
 </div>

 <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
 <span className="text-xs text-slate-400 block uppercase font-bold">Sumário de Julgamento (Jurisprudência)</span>
 <p className="text-slate-600 line-clamp-3 leading-relaxed mt-1 text-sm" title={item.acordao.TITULO}>
 {item.acordao.TITULO}
 </p>
 </div>
 ...
 <div className="text-xs text-slate-400 text-center py-2 border-t border-slate-100 italic">
 ...
 <p className="text-xs text-slate-500">Emissão de Relatório e Exportação Formal — AECI</p>
 </div>
 </div>
 <button
 ...
 <ol className="list-decimal pl-5 text-sm text-slate-600 space-y-1 font-sans">
 ...
 className="w-full py-3 px-4 bg-[#1351b4] hover:bg-[#0f4094] text-white font-bold text-xs rounded-xl flex items-center justify-center gap-2 shadow-xs transition cursor-pointer"
 >
 ...
 className={`w-full py-3 px-4 font-bold text-xs rounded-xl flex items-center justify-center gap-2 border transition cursor-pointer ${copySuccessAlert
 ...
 {copySuccessAlert && (
 <p className="text-xs text-center text-emerald-700 font-bold bg-emerald-50/50 py-1.5 rounded-lg animate-pulse">
 ...
 <p className="text-xs text-blue-200 mt-1">Identificador Único: <span className="">{fullTextAcordao.KEY}</span> | Sessão de {fullTextAcordao.DATASESSAO}</p>
 </div>
 </div>
 <button
 type="button"
 ...
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider">Processo no TCU</span>
 <span className="text-xs text-slate-800 font-bold ">{fullTextAcordao.PROC || "Não informado"}</span>
 </div>
 <div>
 <span className="text-xs text-slate-400 block uppercase font-bold tracking-wider">Assunto Principal (MTE)</span>
 ...
 className={`px-3 py-1.5 rounded-lg text-sm font-bold border transition flex items-center gap-1.5 cursor-pointer ${copySuccessFullText
 ? "bg-emerald-50 border-emerald-300 text-emerald-800"
